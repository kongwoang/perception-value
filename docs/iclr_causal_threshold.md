...
bit-reproducible across runs or platforms. The figures below come from five runs on the reference platform (the
shipped run, two regenerations, and two more with BLAS and OpenMP pinned to 1 and to 4 threads) and one run on a
...
| signal | figure | as quoted | reference platform, 5 runs | second platform | at three decimals |
|---|---|---|---|---|---|
| **pooled, six signals** | point | −0.089 | −0.0891 to −0.0890 | same at 3 dp | safe |
...
| `R1_mlp_clf` | point | −0.095 | −0.0957 to −0.0949 | same at 3 dp | **not safe** (−0.096 / −0.095) |
